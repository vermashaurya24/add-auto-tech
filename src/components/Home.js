...
const sectionCards = [
  {
    ...
    description:
      "Real-time soil moisture data automates watering, saving water and boosting crop health.",
    image:
      "https://images.unsplash.com/photo-1581091012184-5c7b89a7b7c9?q=80&w=1080&auto=format",
  },
  {
    title: "AI-Powered Crop Monitoring",
    description:
      "Drones equipped with AI scan fields to detect crop diseases and anomalies early.",
    image:
      "https://images.unsplash.com/photo-1609630875174-574c94bf4b5d?q=80&w=1080&auto=format",
  },
  {
    title: "Weather Adaptive Sensors",
    description:
      "Sensors dynamically adapt to changing weather conditions for consistent data.",
    image:
      "https://images.unsplash.com/photo-1615572359973-fc0c59c7c94e?q=80&w=1080&auto=format",
  },
];
  ...
  return (
    <div className="pt-56  bg-gradient-to-b from-gray-900 to-black text-white relative min-h-screen flex flex-col items-center justify-center overflow-hidden ">
      ...
      >
        ...
        >
          IoT-based sensors are the future of smart agriculture, enabling
          farmers to monitor and manage their crops with precision and
          efficiency. Our goal is to provide cutting-edge IoT solutions that
          empower farmers to make data-driven decisions, optimize resource
        ...
        <div className="slider-track">
          {cardList.map((card, index) => (
            <Link to={card.href}>
              <motion.div
                key={index}
                className="min-w-[320px] w-[30vw] h-[400px] mx-5 my-8 bg-white/10 backdrop-blur-xl border border-white/20 text-white p-6 rounded-3xl 
              shadow-lg hover:scale-105 transition-transform duration-300 flex flex-col items-center justify-start"
      ...
      <section className="w-full flex flex-col items-center py-20 space-y-24 px-6 md:px-20">
        ...
        >
          ...
          <p className="text-gray-300 mt-4 text-sm md:text-base max-w-2xl mx-auto">
            Explore our latest achievements, innovations, and impactful moments
            in transforming smart agriculture through IoT.
          </p>
        </motion.div>
        ...
        {sectionCards.map((item, index) => {
          ...
          return (
            <motion.div
              key={index}
              className={`flex h-[60vh] flex-col md:flex-row items-center gap-8 w-full md:w-[70vw] bg-white/5 border border-white/20
                rounded-3xl backdrop-blur-md p-8 shadow-2xl relative group overflow-hidden
          ${isEven ? "md:flex-row" : "md:flex-row-reverse"}`}
            ...
            >
              ...
              <div className="absolute bg-gradient-to-tr from-teal-400/10 to-pink-500/5 blur-2xl opacity-30 group-hover:opacity-50 transition duration-500" />
